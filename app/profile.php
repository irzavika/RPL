...
echo 	"<form method=POST action='index.php?app=profile&aksi=update_data' onsubmit='checkForm(this)'>
		<table>
			...
			<tr>
				...
				<td valign='top'>:</td>
				<td><input class='span3' type='password' name='password'></td>
			</tr>
			<tr>
				<td valign='top'><label>Password Verifikasi</label></td>
				<td valign='top'>:</td>
				<td><input class='span3' type='password' name='password2'></td>
			</tr>
			<tr>	
...
if($_SESSION['level'] == 'user'){
	...
	if (mysql_num_rows($sqlcek)==0){
		echo "Anda tidak memiliki beasiswa yang diterima";
	}
	else{
